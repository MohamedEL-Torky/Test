...
void main() async {
  ...
  _camera = CameraController(cameras.first, ResolutionPreset.low, enableAudio: false);
  runApp(MaterialApp(
    ...
    return Scaffold(
      ...
      floatingActionButton: Column(mainAxisAlignment: MainAxisAlignment.end, children: [
        ...
        FloatingActionButton(
          ...
          heroTag: null,
          child:
              _direction == CameraLensDirection.back ? const Icon(Icons.camera_front) : const Icon(Icons.camera_rear),
        ),
      ]),
    );
  }
        ...
        children: <Widget>[
          new Expanded(
            child: new TextField(
              controller: _name,
              autofocus: true,
              decoration: new InputDecoration(labelText: "Name", icon: new Icon(Icons.face)),
            ),
          )
        ],
      ),
